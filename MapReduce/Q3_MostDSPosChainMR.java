...
public class Q3_MostDSPosChainMR {
  ...
  public static class SortReducer extends Reducer<LongWritable,Text,Text,LongWritable>
	...
	public static void main(String[] args)throws Exception
	{
	    ...
	    job1.setJarByClass(Q3_MostDSPosChainMR.class);
	  ...
	  //   job.setNumReduceTasks(0);
	   ...
	   job1.setOutputValueClass(LongWritable.class);
	    ...
	    job2.setJarByClass(Q3_MostDSPosChainMR.class);
	   ...
	   Job job3 = Job.getInstance(conf,"Per Product Id - totalSales");
		job3.setJarByClass(Q3_MostDSPosChainMR.class);
