...
public class Q10_JobSuccessRate 
{
	...
	public static class ReducerClass extends Reducer <Text,Text,LongWritable,Text>
	{
		...
		//Sort Mapper
		  ...
		  public static void main(String[] args) throws Exception {
				...
				Job job=Job.getInstance(conf,"Job Petitions with the success rate more than 70%");
				job.setJarByClass(Q10_JobSuccessRate.class);
				...
				Path outputpath1 = new Path("Successrate2");
				...
				Job job2 = Job.getInstance(conf,"Job Petitions with the success rate more than 70%");
